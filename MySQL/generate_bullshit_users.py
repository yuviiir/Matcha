...
def createUsers():
	...
	while (i < 500):
		...
		"`Pref`, `Verify`, `Matches`, `Chats`, `NewMessage`, `Likes`, `Dislikes`, "
		"`Name`, `Surname`, `Age`, `Email`, `username`, `Password`, "
		"`Gender`, `Popularity`, `Blocked`, `ProfileViews`, `ProfileLikes`, `Suburb`, `Postal Code`, `Sexual Orientation`, "
		"`Bio`, `Animals`, `Music`, `Sports`, `Food`, `Movies`, "
		"`Noti`, `Images`, `Token`, `ConnectionStatus`) "
		"VALUES ("
		"%s, %s, %s, %s, %s, %s, %s,"
		"%s, %s, %s, %s, %s, %s,"
		"%s, %s, %s, %s, %s, %s, %s, %s,"	
		...
		"%s, %s, %s, %s)")
		val = ("1", "1", "", "", "false", "", "",
				name, surname, int(age), email, username, hash_password('Password123!'),
				gender, int(popularity), "", "", "", location, int(random.randint(1000, 2999)), SO,
				'I am ' + name, animalsQuery, musicQuery, sportsQuery, foodQuery, moviesQuery,
				"1", 'trtvyoxhwtnwcxw1, vxrscllmrvqimvu2, ggzdavmalijyoun3, temeocunmfgvgtx4, nemgggxqfkphbkh5', "", lastSeen)
